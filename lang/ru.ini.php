...
found x records in table y = "<b>Найдено</b> $found из $total записей в таблице <b><i>$table</i></b><br/><b>Отображено</b> $cursor из $found"
templates.Dataface_ResultListController.MESSAGE_FOUND_RECORDS = "<b>Найдено</b> $found из $total записей в таблице <b><i>$table</i></b><br/><b>Отображено</b> $start из $end"
scripts.Dataface.RelatedList.toHtml.MESSAGE_FOUND = "<b>Найдено</b> $num записей в связи <i>$relationship</i>"
scripts.Dataface.RelatedList.toHtml.MESSAGE_NOW_SHOWING = "<b>Отображено</b> <i>$start</i> из <i>$finish</i>"
scripts.GLOBAL.MESSAGE_FOUND = "Всего $found записей"
...
scripts.GLOBAL.LABEL_LOGOUT = "Выход"
Actions menu title = "Actions to be performed"
actions.update_selected.label = "Изменить..."
actions.update_selected_related.label = "Изменить..."
actions.update_selected_related.description = "Изменение выбранных записей"
actions.update_set.description = "Изменение всех записей в текущей выборке"
actions.delete.description = "Удаление текущей записи"
...
scripts.GLOBAL.LABEL_LOGIN_SUBMIT = "Войти"
actions.register.label = "Register"
actions.view.label = "Просмотр"
scripts.GLOBAL.LABEL_SHOWING = "Отображается"
templates.actions_manage_migrate.LABEL_PERFORM_MIGRATIONS = "Perform selected migrations"
actions.update_selected.description = "Изменение отмеченных записей"
actions.udpate_selected_related.description = "Изменение отмеченных записей"
actions.copy_selected.description = "Копирование отмеченных записей"
actions.remove_selected_related.description = "Удаление отмеченных записей из данной связи"
actions.delete_selected.description = "Удаление отмеченных записей"
templates.copy_replace.HEADING_SELECTED_RECORDS = "Выбранные записи:"
...
scripts.Dataface.RelatedList.toHtml.LABEL_ADD_EXISTING_RELATED_RECORD = "Добавить существующую запись $relationship"
templates.Dataface_submit_translation.LABEL_SUBJECT = "Subject"
scripts.GLOBAL.FORMS.OPTION_PLEASE_SELECT = "Выберите из списка..."
actions.register.MESSAGE_USERNAME_REQUIRED = "Please enter a username"
Please Login = "Пожалуйста авторизуйтесь для получения доступа"
...
actions.export_csv.label = "Экспорт в CSV"
actions.export_csv_related.label = "Экспорт в CSV"
scripts.Dataface.HistoryTool.restore.ERROR_NO_SUCH_RECORD = "Невозможно восстановить запись с id '$id' в таблице '$tablename', т.к. такая запись отсутствует. Вероятно история была удалена."
...
templates.Dataface_Import_Related_Records.HEADING_IMPORT_RECORDS_FORM = "Импорт записей"
actions.import.label = "Импорт"
actions.import.description = "Import records into table"
templates.Dataface_DeleteForm.DELETE_RECORDS = "Удаление записей"
...
scripts.GLOBAL.LABEL_ADD_ROW = "Добавить запись"
actions.find_list.description = "Find records in {$query['-table']} category only."
templates.Dataface_RecordHistory.LABEL_DATE = "Date"
actions.history_restore_record.description = "Отменить все изменения и восстановить текущую запись на данную версию"
...
actions.browse.label = "Запись"
templates.Dataface_RecordHistory.LABEL_DETAILS = "Details"
scripts.Dataface_FormTool.LABEL_EDIT_DETAILS = "Основные данные"
scripts.Dataface_QuickForm.LABEL_EDIT_DETAILS = "Основные данные"
...
templates.RecordNavMenu.HEADING_THIS_RECORD = "Текущая запись"
...
scripts.Dataface.RemoveRelatedRecordForm._build.LABEL_REMOVE = "Удалить"
actions.remove_selected_related.label = "Удалить..."
...
actions.export_json.description = "Экспорт текущей выборки в формате JSON"
actions.export_xml.description = "Экспорт текущей выборки в формате XML"
scripts.GLOBAL.MESSAGE_RESULTS_PER_PAGE = " записей на странице"
...
actions.manage_build_index.description = "Перестроить поисковый индекс для глобального поиска."
...
scripts.GLOBAL.NO_RECORDS_MATCHED_REQUEST = "Отсутствуют записи соответствующие вашему запросу."
scripts.GLOBAL.MESSAGE_NO_MATCH = "Отсутствуют записи соответствующие вашему запросу."
actions.export_csv.description = "Экспорт текущей выборки в CSV формате"
actions.export_csv_related.description = "Экспорт текущей выборки в CSV формате"
...
scripts.GLOBAL.HEADING_ERRORS = "Ошибка"
...
scripts.GLOBAL.MESSAGE_VIEW_FIELD_CONTENT = "Открыть в новом окне..."
actions.find.label = "Поиск"
scripts.GLOBAL.LABEL_FIND = "Искать"
...
actions.delete_found.description = "Удаление ВСЕХ! записей в текущей выборке"
actions.delete_found.label = "Удалить ВСЮ! выборку..."
actions.update_set.label = "Изменить всю выборку..."
actions.copy_replace.label = "Копировать всю выборку..."
actions.copy_replace_ui.label = "Копировать всю выборку..."
actions.history.label = "История"
...
actions.calendar.label = "Календарь"
...
scripts.Dataface_SearchForm.LABEL_MATCH_NONE = "Исключить выбранное"
...
actions.copy_selected.label = "Копировать..."
actions.copy_replace.description = "Копирование всех записей в текущей выборке"
actions.copy_replace_ui.description = "Копирование всех записей в текущей выборке"
scripts.Dataface.DeleteForm._build.LABEL_DELETE = "Удалить"
actions.delete.label = "Удалить"
actions.delete_selected.label = "Удалить..."
templates.RecordNavMenu.MESSAGE_LOADING = "Загрузка ..."
templates.Dataface_RecordHistory.MESSAGE_LOADING = "Загрузка ... Пожалуйста подождите ..."
templates.copy_replace_quickform_element_template.LABEL_MAKE_BLANK = "Очистить поле"
scripts.GLOBAL.LABEL_LAST_MODIFIED = "Last updated $last_mod"
scripts.GLOBAL.LABEL_RECENT_RECORDS = "Recent Records"
actions.list.label = "Все записи"
actions.manage_output_cache.description = "Management options for the Xataface output cache."
actions.my_profile.label = "Профиль пользователя"
actions.manage_migrate.label = "Миграция"
actions.manage_migrate.description = "Поддержка миграций на новые версии ПО."
actions.change_password.label = "Смена пароля"
actions.forgot_password.label = "Восстановление пароля"
actions.clear_views.label = "Очистить __sql__ Views"
scripts.Dataface_ResultList.MESSAGE_WITH_SELECTED = "С отмеченными"
scripts.GLOBAL.LABEL_WITH_SELECTED = "С отмеченными"
...
scripts.Dataface.RelatedList.toHtml.LABEL_ADD_NEW_RELATED_RECORD = "Добавить новую запись $relationship"
actions.new_related_record.label = "Add new {$query['-relationship']} record"
actions.new.description = "Создать новую запись"
actions.new.label = "Новая запись"
...
scripts.Dataface_ResultList.MESSAGE_FILTER_RESULTS = "Строка фильтра"
actions.rss.label = "RSS"
actions.related_rss.label = "RSS"
actions.related_rss.description = "RSS feed данной связи"
actions.rss.description = "RSS Feed для текущей выборки"
...
scripts.Dataface.DeleteForm.display.ARE_YOU_SURE_MULTIPLE = "Вы действительно желаете удалить ВЕСЬ набор записей?  $num записей будет УДАЛЕНО."
templates.Dataface_RecordHistory.JS_STRING_CONFIRM_RESTORE = "'Вы действительно желаете восстановить содержимое текущей записи до предыдущей версии с id '+id+'?'"
scripts.Dataface.DeleteForm.display.ARE_YOU_SURE = "Вы действительно желаете удалить эту запись: &quot;$displayCol&quot;?"
scripts.Dataface.RemoveRelatedRecordForm.display.MESSAGE_ARE_YOU_SURE = "Вы действительно желаете удалить следующие записи из связи '$relationship'?"
Incorrect Password = "Неверные имя пользователя или пароль."
...
scripts.GLOBAL.LABEL_SEARCH = "Поиск"
actions.manage_build_index.label = "Перестроить индекс"
actions.manage.label = "Утилиты"
...
actions.history_restore_record.label = "Восстановить"
...
actions.view_xml.label = "Экспорт в XML"
actions.export_xml.label = "Экспорт в XML"
...
actions.find.show_search_instructions_link = "Подсказка по поиску"
actions.find.advanced_search_heading = "Продвинутый поиск"
...
You are now logged in = "Вы успешно вошли в систему"
You are already logged in = "Вход в систему уже выполнен"
actions.copy_replace.default_success_message = "Records successfully updated."
actions.copy_replace.options.select_field_to_change = "Выберите поле..."
actions.copy_replace.copy_message = "С помощью данного экрана можно скопировать выбранные записи изменив отдельные поля в копиях."
actions.copy_replace.copy_form_title = "Групповое копирование"
actions.copy_replace.copy_warning_message = "Выполнение данной операции создаст копии выбранных записей. Будьте осторожны."
actions.copy_replace.update_message = "С помощью данного экрана можно выполнить групповые изменения выбранных записей.<br>Выберите поля, которые нужно изменить и требуемые значения в элементах ниже."
actions.copy_replace.update_warning_message = "Выполнение данной операции изменит ВСЕ выбранные записи без возможности восстановления. Будьте осторожны."
actions.copy_replace.update_form_title = "Групповое изменение"
actions.copy_replace.submit_label = "Выполнить"
...
actions.copy_replace.x_records_y_successfully_count_warnings = "%d записей %s успешно. В ходе выполнения возникло %d предупреждений."
...
forgot_password.heading = "Восстановление пароля"
forgot_password.options.email = "My Email Address is:"
forgot_password.options.username = "My username is:"
forgot_password.login_now = "Войти снова"
Last updated date = "Последнее обновление %s"
x weeks ago = "%d недель назад"
x days ago = "%d дней назад"
Today = "Сегодня"
Yesterday = "Вчера"
a week ago = "неделю назад"
display x records per page = "Отображается %s записей на странице"
...
Errors occurred = "В ходе выполнения произошли ошибки"
x records were deleted = "Удалено %d записей."
No errors occurred = "Операция завершена без ошибок."
Record successfully added to relationship = "Record successfully added to "XATAFACEQ".$query['-relationship']."XATAFACEQ" relationship.\n"
help = "Помощь"
...
Record successfully saved = "Изменения сохранены."
...
insert_new_x = "Новая запись: $x"
edit_new_x_y = "Редактирование: $x > $y"
Dataface_RecordView_Details_Label = "Основные данные"
templates.copy_replace.label.add_field = "Обновляемое поле"
templates.copy_replace_quickform_element_template.LABEL_REMOVE_FIELD = "Убрать из списка"
sidebar.see_all = "Все..."
actions.delete_selected.confirm = "Вы действительно хотите удалить выбранные записи?"
add_new_x = "Новая запись: $x"
select.other = "Новое..."
checkbox.other = "Новое..."
copied = "скопировано"
updated = "изменено"
actions_menu.more.label = "Ещё"
actions_menu.more.description = "Другие таблицы..."
widget.table.delete = "Удалить"
widget.table.addrow = "Добавить"
actions.personal_tools_logout.label = "Выход"
actions.list_filter.label = "Фильтр"
actions.list_filter.description = "Фильтр записей"
actions.list_sort.label = "Сортировка"
actions.list_sort.description = "Сортировка записей"
actions.related_list_filter.label = "Фильтр"
actions.related_list_filter.description = "Фильтр связанных записей"
actions.related_list_sort.label = "Сортировка"
actions.related_list_sort.description = "Сортировка связанных записей"
actions.new.new_record_header_label = "Новая запись в "
actions.new_add.new_record_header_label = "Добавить запись в "
actions.new.breadcrumb_label = "Новая запись"
widget.select.other = "Новая..."
