...
actions.summary_edit.label = "Bewerken"
templates.Dataface_RecordHistory.LABEL_CHANGES = "Veranderingen"
scripts.GLOBAL.LABEL_SUBMIT = "Verstuur"
templates.Dataface_submit_translation.LABEL_SUBMIT = "Verstuur"
actions.submit_translation.description = "Plaats hier zelf een vertaling"
actions.translate_found_babelfish.label = "Vertaal gevonden data"
actions.translate.label = "Vertaal"
actions.translate_found_babelfish.description = "Vertaal gevonden gegevens met behulp van Google webservice"
templates.Dataface_submit_translation.LABEL_TRANSLATED_TEXT = "Vertaalde tekst:"
actions.submit_translation.label = "Voeg een vertaling toe"
templates.Dataface_submit_translation.HEADING = "Voeg een vertaling toe"
actions.invalidate_translations.label = "Verkeerde vertaling"
scripts.Dataface.TranslationForm.LABEL_TRANSLATION_STATUS = "Vertaal Status"
actions.set_translation_status.label = "Pas vertaalstatus aan"
templates.Dataface_set_translation_status.HEADING_SET_TRANSLATION_STATUS = "Pas vertaalstatus aan"
found x records in table y = "<b>Gevonden</b> $found van $total records in tabel <b><i>$table</i></b><br/><b>Nu te zien</b> $cursor van $found"
...
scripts.Dataface.RelatedList.toHtml.MESSAGE_FOUND = "<b>Gevonden</b> $num record in relatie <i>$relationship</i>"
scripts.Dataface.RelatedList.toHtml.MESSAGE_NOW_SHOWING = "<b>Nu te zien</b> <i>$start</i> to <i>$finish</i>"
scripts.GLOBAL.MESSAGE_FOUND = "$found records gevonden"
templates.ImportForm_step2.HEADING_FOUND_RECORDS = "$num records gevonden om te importeren"
scripts.Dataface_RelationshipCheckboxForm.MESSAGE_NUM_RECORDS_ADDED = "$num_added record zijn succesvol toegevoegd aan de relatie"
scripts.Dataface_RelationshipCheckboxForm.MESSAGE_NUM_RECORDS_REMOVED = "$num_removed records zijn succesvol verwijderd van de relatie"
scripts.Dataface.RelatedList.toHtml.LABEL_IMPORT_RELATED_RECORDS = "Import $relationship Records"
scripts.GLOBAL.LABEL_LOGOUT = "Afmelden"
Actions menu title = "Acties uitvoeren"
actions.update_selected.label = "Bijwerken"
actions.update_selected_related.label = "Bijwerken"
actions.update_set.description = "De gevonden data als groep bijwerken"
actions.delete.description = "Huidige record verwijderen"
templates.Dataface_Record.LABEL_CURRENT_RECORD = "Huidige record"
...
actions.show_all.description = "Alle data in de tabel laten zien"
actions.show_all.label = "Alles laten zien"
scripts.GLOBAL.LABEL_DATE_CREATED = "Gemaakt $created"
Logged in as user = "Ingelogd als {$username}"
templates.Dataface_Import_Related_Records.HEADING_INSTRUCTIONS = "Instructies"
Dataface_Registration.label = "Aanmeld formulier"
Login Form = "Aanmeld formulier"
scripts.GLOBAL.LABEL_LOGIN = "Aanmelden"
actions.register.label = "Registreren"
actions.view.label = "Bekijken"
scripts.GLOBAL.LABEL_SHOWING = "Nu bekijken"
templates.actions_manage_migrate.LABEL_PERFORM_MIGRATIONS = "Geselecteerde migraties uitvoeren"
actions.update_selected.description = "Geselecteerde data bijwerken"
actions.udpate_selected_related.description = "Geselecteerde data bijwerken"
actions.copy_selected.description = "Kopieer geselecteerde data"
actions.remove_selected_related.description = "Verwijder geselecteerde data van deze relatie"
actions.delete_selected.description = "Verwijder geselecteerde data"
templates.copy_replace.HEADING_SELECTED_RECORDS = "Geselecteerde data"
scripts.Dataface.ExistingRelatedRecordForm._build.LABEL_SELECT = "Selecteer"
scripts.Dataface.ExistingRelatedRecordForm._build.ERROR_GETTING_FOREIGN_KEY_COLS = "Fout bij het verkrijgen van van de foreign key columns bij het bouwen van de Related Record Form op lijn $line van bestand $file"
templates.Dataface_RecordHistory.LABEL_USER = "Gebruiker"
Username = "Gebruikersnaam"
scripts.Dataface.RelatedList.toHtml.LABEL_ADD_EXISTING_RELATED_RECORD = "Voeg bestaande $relationship Record toe"
templates.Dataface_submit_translation.LABEL_SUBJECT = "Onderwerp"
scripts.GLOBAL.FORMS.OPTION_PLEASE_SELECT = "Graag selecteren..."
actions.register.MESSAGE_USERNAME_REQUIRED = "Geef een gebruikers naam in"
Please Login = "Om toegang te krijgen tot dit deel van website dient u in te loggen"
scripts.Dataface.ImportForm._build.MESSAGE_IMPORT_FILE_FORMAT_REQUIRED = "Import File Format is a required field"
actions.register.MESSAGE_EMAIL_REQUIRED = "Geef een geldig emailadres. Er wordt een email verzonden naar dit adres met de activatie  gegevens"
actions.register.MESSAGE_PASSWORD_REQUIRED = "Geef een wachtwoord"
actions.export_csv.label = "Exporteren als CSV"
actions.export_csv_related.label = "Exporteren als CSV"
...
scripts.Dataface.ModuleTool.loadModule.ERROR_MODULE_DOES_NOT_EXIST = "De module '$name' bestaat niet"
...
templates.actions_manage_migrate.HEADING_MIGRATION_MANAGER = "Migratie Manager"
templates.Dataface_Import_Related_Records.HEADING_IMPORT_RECORDS_FORM = "Import Records Form"
actions.import.label = "Data importeren"
actions.import.description = "Data importeren in tabel"
templates.Dataface_DeleteForm.DELETE_RECORDS = "Verwijder data"
templates.Dataface_set_translation_status.LABEL_RECORD = "Data"
actions.summary_edit.description = "Bewerk deze data"
No records found = "Data voor tabel '$table' niet gevonden"
scripts.GLOBAL.LABEL_ADD_ROW = "Regel toevoegen"
...
actions.search_index.label = "Deze website"
...
actions.register.LABEL_A_DATAFACE_APPLICATION = "een Xataface Applicatie"
Successfully deleted record = "Successfully deleted entry for record '$title' in table '$table'"
scripts.Dataface.RemoveRelatedRecordForm._build.LABEL_REMOVE = "Verwijderen"
actions.remove_selected_related.label = "Verwijderen"
actions.remove_related_record.label = "Verwijderen"
actions.edit_event_details.label = "Bewerk activiteit details"
actions.view_event_details.label = "Bekijk activiteit details"
...
scripts.GLOBAL.MESSAGE_RESULTS_PER_PAGE = " resultaten per pagina"
...
scripts.Dataface.ImportForm._build.MESSAGE_PROCEED_WITH_IMPORT = "Ziet er goed uit. Doorgaan met importeren"
actions.manage_build_index.description = "Bouw en en ondehoud een zoekindex voor een volledige site search"
scripts.Dataface.TranslationForm.ERROR_NO_RECORD_FOUND = "Geen data gevonden om te vertalen"
...
actions.delete_found.label = "verwijder groep"
actions.update_set.label = "groep bijwerken"
actions.copy_replace.label = "Groep kopieeren"
actions.history.label = "Geschiedenis"
templates.Dataface_RecordHistory.LABEL_ID = "ID"
templates.Dataface_submit_translation.LABEL_NAME = "Uw naam"
...
actions.copy_selected.label = "Kopiëren"
actions.copy_replace.description = "Kopieer de gevonden resultaten."
scripts.Dataface.DeleteForm._build.LABEL_DELETE = "Verwijderen"
actions.delete.label = "Verwijderen"
actions.delete_selected.label = "Verwijderen"
templates.RecordNavMenu.MESSAGE_LOADING = "Laden...."
templates.Dataface_RecordHistory.MESSAGE_LOADING = "Laden.... effe wachten...."
templates.copy_replace_quickform_element_template.LABEL_MAKE_BLANK = "Maak leeg"
scripts.GLOBAL.LABEL_LAST_MODIFIED = "Laatste update $last_mod"
scripts.GLOBAL.LABEL_RECENT_RECORDS = "recente data"
actions.list.label = "lijst"
actions.manage_output_cache.description = "Management options for the Xataface output cache."
actions.my_profile.label = "Mijn porfiel"
actions.manage_migrate.label = "Migratie"
actions.manage_migrate.description = "A tool to help migrate to newer versions of Xataface."
scripts.Dataface_ResultList.MESSAGE_WITH_SELECTED = "Met geselecteerde:"
scripts.GLOBAL.LABEL_WITH_SELECTED = "Met geselecteerde:"
templates.actions_manage_migrate.MESSAGE_NO_MIGRATIONS = "There are currently no migrations to be performed."
scripts.GLOBAL.LABEL_MOVE_UP = "Naar boven"
scripts.GLOBAL.LABEL_MOVE_DOWN = "naar beneden"
...
actions.new.description = "Voeg gegevens toe"
actions.new.label = "Nieuwe gegevens"
actions.view_original.label = "Bekijk origineel"
templates.Dataface_submit_translation.LABEL_ORIGINAL_TEXT = "Orginele tekst"
...
scripts.Dataface.TranslationForm.LABEL_SOURCE_TRANSLATION = "Bronvertaling"
scripts.Dataface_ResultList.MESSAGE_FILTER_RESULTS = "Filter Resultaat"
...
scripts.Dataface_SkinTool.LABEL_BREADCRUMB = "Je bent hier"
...
scripts.Dataface_RelationshipCheckboxForm.LABEL_SUBMIT = "Opslaan"
templates.Dataface_RecordHistory.LABEL_LANGUAGE = "Taal"
...
scripts.Dataface.TranslationForm.LABEL_VERSION = "Versie"
...
scripts.GLOBAL.MESSAGE.PERMISSION_DENIED = "Toegang geweigerd"
Permission Denied = "Toegang geweigerd"
scripts.Dataface.DeleteForm.checkPermissions.ERROR_PERMISSION_DENIED = "Toegang geweigerd: niet de juiste rechten om dit record te verwijderen ($title)"
scripts.GLOBAL.LABEL_BACK = "Terug"
scripts.GLOBAL.LABEL_GO_BACK = "Ga terug"
actions.find.show_search_instructions_link = "Show Search Instructions"
actions.find.advanced_search_heading = "Geavanceerd zoeken"
actions.find.short_help_blurb = "Vul in de velden hieronder je zoektermen in en klik op zoeken"
actions.find.instructions.simple_searches.heading = "Eenvoudig zoeken"
actions.find.instructions.boolean_searches.body = "<br/> Przykład: Jeśli wpiszesz „Deszcz” do jednego z pól, spowoduje to znalezienie rekordów, które zawierają frazę &quot;Deszcz&quot;.  A w tym &quot;deszczyk&quot; &quot;deszczółka;&quot; itp..."
actions.find.instructions.boolean_searches.heading = "Boolean Zoeken"
actions.find.instructions.exact_matches.heading = "exact zoeken"
...
actions.find.instructions.less_than_greater_than.body = "Prepending a less than (&quot;&lt;&quot;) or greater than (&quot;&gt;&quot;) sign to a will match records where the field has a value LESS THAN (respectively GREATER THAN) the specified value.
...
actions.find.instructions.wildcard_searches.heading = "Zoeken met een Wildcard"
